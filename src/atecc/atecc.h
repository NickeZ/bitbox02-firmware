 ...
 * Calling this function for ATECC_SLOT_ROLLKEY also increments the
 * monotonic counter Counter0.
 * @param[in] slot should be one of ATECC_SLOT_ROLLKEY and
 *            ATECC_SLOT_KDF.
 ...
 * @return True if success
 */
USE_RESULT bool atecc_ecc_unsafe_sign(
