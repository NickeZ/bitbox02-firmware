...
pub use widgets::buttonmatrix::{ButtonmatrixExt, LvButtonmatrix, LvButtonmatrixMapError};
...
pub use widgets::keyboard::{KeyboardExt, LvKeyboard, LvKeyboardMapError, keyboard_def_event_cb};
