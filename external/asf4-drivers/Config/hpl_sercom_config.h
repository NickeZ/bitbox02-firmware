...
#define CONF_SERCOM_5_I2CM_TRISE 60
#endif
...
#define CONF_SERCOM_5_I2CM_SPEED 0x01 // Speed: Fast mode+
#endif
#if CONF_SERCOM_5_I2CM_TRISE < 60 || CONF_SERCOM_5_I2CM_TRISE > 100
#warning Bad I2C Rise time for Fast mode+, reset to 60ns
#undef CONF_SERCOM_5_I2CM_TRISE
#define CONF_SERCOM_5_I2CM_TRISE 60U
#endif
